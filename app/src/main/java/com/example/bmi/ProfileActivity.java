...
public class ProfileActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> genderArray = ArrayAdapter.createFromResource(this, R.array.gender_array, android.R.layout.simple_spinner_item);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String name, mobile, age, gender, weight, height;
    ...
    {
        userImage = findViewById(R.id.image_profile_id);
        userName = findViewById(R.id.name_profile_id);
        userEmail = findViewById(R.id.email_profile_id);
        userMobile = findViewById(R.id.mobile_profile_id);
        userAge = findViewById(R.id.age_profile_id);
        userWeight = findViewById(R.id.weight_profile_id);
        userHeight = findViewById(R.id.height_profile_id);
        genderSpinner = findViewById(R.id.gender_profile_id);
        saveButton = findViewById(R.id.saveButton_profile_id);
        progressBar = findViewById(R.id.progressBar_profile_id);
        scrollView = findViewById(R.id.scrollView_profile_id);
